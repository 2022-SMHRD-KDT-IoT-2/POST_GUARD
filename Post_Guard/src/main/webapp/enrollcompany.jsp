...
%>
		...
		<div class="mypage__container">
			...
			<div class="mypage__section2">
				<div class="company__enroll-container">
					<span class="company__enroll-text">택배사 등록</span>
					<div class="company__enroll">
						<span class="company__enroll--notifi">등록한 택배사는 발송 예약 페이지에서 고객들이 확인 할 수 있습니다.</span>
						<div class="company_enroll--input">
							<span>택배사 이름</span>
							<input class="companyName" type="text" required/>
						</div>
						<div class="company_enroll--input">
							<span>택배사 주소</span>
							<input class="companyAddr" type="text" required/></div>
						<div class="company_enroll--input">
							<span>택배사 전화번호</span>
							<input class="companyTel" type="text" required/></div>
						<div class="company_enroll--input">
							<span>택배사 CEO</span>
							<input class="companyCEO" type="text" required/>
						</div>
						<div class="company_enroll--input">
							<span>택배사 홈페이지</span>
							<input class="companyPage" type="text" required/>
						</div>
					</div>
 ...
 사업자 등록번호 : 375-87-00088 직업정보제공사업 신고번호 : J1200020200016</span>
	...
	<script src="assets/js/enrollcompany.js"></script>
</body>
</html>