...
pageEncoding="UTF-8"%> <%@ page import="com.dao.MemberDAO" %> <%@ page
...
<html lang="en">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/44ebe7b134.js"
      ...
      <div class="inner">
        <nav>
          <ul>
            <li>
              <a href="index.jsp"
                ><img class="mainlogo" src="./images/logo(white).png"
              /></a>
            </li>
    ...
    <footer id="footer" style="color: rgb(9, 41, 97)">
      <div class="footer__inner">
        ...
        <div class="footer__down">
          <span
            >광주 동구 예술길 31-15 광주아트센터 4층 (POST-GUARD) 사업자
